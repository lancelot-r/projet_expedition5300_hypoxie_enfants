...
ordre_villes <- c("Lima", "Cusco", "Juliaca", "Rinconada")  # Remplacez par l'ordre souhaité
...
summary_table <- bind_rows(quant_table, qual_table) %>%
  ...
  select(variable, all_of(ordre_villes))
...
for (ville in ordre_villes) {  # <- utilise l'ordre défini
