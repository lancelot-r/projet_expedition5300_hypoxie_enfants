...
data_long <- data %>%
  pivot_longer(
    cols = c(Anemie_OMS2011, Anemie_OMS2024, Anemie_SD, Anemie_1.5SD, Anemie_2SD),
    names_to = "Méthode",
    values_to = "Résultat"
  ) %>%
  mutate(
...
data_long$Méthode <- factor(
  data_long$Méthode,
  levels = c("Anemie_OMS2011", "Anemie_SD", "Anemie_2SD", "Anemie_OMS2024", "Anemie_1.5SD"),
...
data_long <- data %>%
  pivot_longer(
    cols = c(Anemie_OMS2011, Anemie_OMS2024, Anemie_SD, Anemie_1.5SD, Anemie_2SD, Anemie_SD_Hbmass_kg, Anemie_1.5SD_Hbmass_kg, Anemie_2SD_Hbmass_kg),
    names_to = "Méthode",
    values_to = "Résultat"
  ) %>%
  mutate(
...
data_long$Méthode <- factor(
  data_long$Méthode,
  levels = c("Anemie_SD", "Anemie_SD_Hbmass_kg", "Anemie_OMS2011", "Anemie_1.5SD", 
             "Anemie_1.5SD_Hbmass_kg", "Anemie_OMS2024", "Anemie_2SD", "Anemie_2SD_Hbmass_kg"),
...
data_long$Méthode <- factor(
  data_long$Méthode,
  levels = c("Anemie_OMS2011", "Anemie_OMS2024", "Anemie_SD", "Anemie_1.5SD", "Anemie_2SD"),
...
data_long$Méthode <- factor(
  data_long$Méthode,
  levels = c("Anemie_OMS2011", "Anemie_OMS2024", "Anemie_SD", "Anemie_1.5SD", "Anemie_2SD", "Anemie_SD_Hbmass_kg", "Anemie_1.5SD_Hbmass_kg", "Anemie_2SD_Hbmass_kg"),
...
data = read.csv("datafinalfinal.csv")
data_clean <- data %>%
  drop_na(Anemie_OMS2024, Anemie_1.5SD)
...
pval = mcnemar_auto(data_clean$Anemie_OMS2024, data_clean$Anemie_1.5SD)$p.value
methode = mcnemar_auto(data_clean$Anemie_OMS2024, data_clean$Anemie_1.5SD)$method
n_total <- nrow(data_clean)
...
# Construire la heatmap
data_clean %>%
  count(Anemie_OMS2024, Anemie_1.5SD) %>%
  group_by(Anemie_1.5SD) %>%
  mutate(prop = n / sum(n)) %>%
  ggplot(aes(x = Anemie_OMS2024, y = Anemie_1.5SD, fill = prop)) +
  geom_tile(color = "white") +
  geom_text(aes(label = paste0(scales::percent(prop, accuracy = 1), "\n(n=", n, ")")), size = 5) +
  scale_fill_gradient(low = "white", high = "red") +
  labs(
...
data = read.csv("datafinalfinal.csv")
data_clean <- data %>%
  drop_na(Anemie_OMS2011, Anemie_1.5SD)
...
pval = mcnemar_auto(data_clean$Anemie_OMS2011, data_clean$Anemie_1.5SD)$p.value
methode = mcnemar_auto(data_clean$Anemie_OMS2011, data_clean$Anemie_1.5SD)$method
n_total <- nrow(data_clean)
...
# Construire la heatmap
data_clean %>%
  count(Anemie_OMS2011, Anemie_1.5SD) %>%
  group_by(Anemie_1.5SD) %>%
  mutate(prop = n / sum(n)) %>%
  ggplot(aes(x = Anemie_OMS2011, y = Anemie_1.5SD, fill = prop)) +
  geom_tile(color = "white") +
  geom_text(aes(label = paste0(scales::percent(prop, accuracy = 1), "\n(n=", n, ")")), size = 5) +
  scale_fill_gradient(low = "white", high = "red") +
  labs(
...
data = read.csv("datafinalfinal.csv")
data_clean <- data %>%
  drop_na(Anemie_OMS2024, Anemie_1.5SD_Hbmass_kg)
...
pval = mcnemar_auto(data_clean$Anemie_OMS2024, data_clean$Anemie_1.5SD_Hbmass_kg)$p.value
methode = mcnemar_auto(data_clean$Anemie_OMS2024, data_clean$Anemie_1.5SD_Hbmass_kg)$method
n_total <- nrow(data_clean)
...
# Construire la heatmap
data_clean %>%
  count(Anemie_OMS2024, Anemie_1.5SD_Hbmass_kg) %>%
  group_by(Anemie_1.5SD_Hbmass_kg) %>%
  mutate(prop = n / sum(n)) %>%
  ggplot(aes(x = Anemie_OMS2024, y = Anemie_1.5SD_Hbmass_kg, fill = prop)) +
  geom_tile(color = "white") +
  geom_text(aes(label = paste0(scales::percent(prop, accuracy = 1), "\n(n=", n, ")")), size = 5) +
  scale_fill_gradient(low = "white", high = "red") +
  labs(
...
data = read.csv("datafinalfinal.csv")
data_clean <- data %>%
  drop_na(Anemie_OMS2011, Anemie_1.5SD_Hbmass_kg)
...
pval = mcnemar_auto(data_clean$Anemie_OMS2011, data_clean$Anemie_1.5SD_Hbmass_kg)$p.value
methode = mcnemar_auto(data_clean$Anemie_OMS2011, data_clean$Anemie_1.5SD_Hbmass_kg)$method
n_total <- nrow(data_clean)
...
# Construire la heatmap
data_clean %>%
  count(Anemie_OMS2011, Anemie_1.5SD_Hbmass_kg) %>%
  group_by(Anemie_1.5SD_Hbmass_kg) %>%
  mutate(prop = n / sum(n)) %>%
  ggplot(aes(x = Anemie_OMS2011, y = Anemie_1.5SD_Hbmass_kg, fill = prop)) +
  geom_tile(color = "white") +
  geom_text(aes(label = paste0(scales::percent(prop, accuracy = 1), "\n(n=", n, ")")), size = 5) +
  scale_fill_gradient(low = "white", high = "red") +
  labs(
